...
--
-- Table structure for table `ua_accounts`
--
...
--
-- Stand-in structure for view `ua_accounts_head`
--
...
--
-- Table structure for table `ua_custom_fields`
--
...
--
-- Stand-in structure for view `ua_custom_fields_head`
--
...
--
-- Table structure for table `ua_object_register`
--
...
--
-- Table structure for table `ua_object_types`
--
...
--
-- Table structure for table `ua_sessions`
--
...
--
-- Table structure for table `ua_session_register`
--
...
--
-- Stand-in structure for view `ua_users_head`
--
...
--
-- Structure for view `ua_accounts_head`
--
...
--
-- Structure for view `ua_custom_fields_head`
--
...
--
-- Structure for view `ua_users_head`
--
